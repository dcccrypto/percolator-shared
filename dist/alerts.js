 ...
 */
export async function sendAlert(message, severity, fields) {
 ...
 */
export async function sendCriticalAlert(message, fields) {
    await sendAlert(message, "critical", fields);
}
/**
 * Send a warning alert
 */
export async function sendWarningAlert(message, fields) {
    await sendAlert(message, "warning", fields);
}
/**
 * Send an info alert
 */
export async function sendInfoAlert(message, fields) {
