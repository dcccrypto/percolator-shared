 ...
 */
// ---------------------------------------------------------------------------
// WrapperConfigV16 (the 432-byte v17 market-group config block)
// ---------------------------------------------------------------------------
/**
...
// ---------------------------------------------------------------------------
// AssetOracleProfileV16 (400-byte per-asset oracle profile)
// ---------------------------------------------------------------------------
/**
 * v17 AssetOracleProfileV16 byte length.
 * Was 368 bytes in v16; grew to 400 in v17 (per-asset asset_admin + oracle fields).
 */
export const ASSET_ORACLE_PROFILE_V16_LEN = 400;
// ---------------------------------------------------------------------------
// Market-group account header + offsets
// ---------------------------------------------------------------------------
/**
 ...
 */
export const MARKET_GROUP_OFF = V17_HEADER_LEN + WRAPPER_CONFIG_LEN; // 448
// ---------------------------------------------------------------------------
// v17 magic / version identifiers
// ---------------------------------------------------------------------------
/**
 * v17 account magic as a BigInt ("PERCV16\0" little-endian u64).
 * Stored at bytes [0..8] of every v17 percolator-owned account.
 */
export const V17_MAGIC = 0x5045524356313600n;
/**
